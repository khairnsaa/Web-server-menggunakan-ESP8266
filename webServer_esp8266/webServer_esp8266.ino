      ...
      if (c == '\n') { // if the byte is a newline character
        ...
        if (currentLine.length() == 0) {
          ...
          // Web Page Heading
           ...
           if(output5State=="off"){
            client.println("<p><a href=\"/5/on\"><buttonclass=\"button\">ON</button></a></p>");
           } else {
            client.println("<p><a href=\"/5/off\"><button class=\"buttonbutton2\">OFF</button></a></p>");
           }
           ...
           if (output4State=="off") {
            client.println("<p><a href=\"/4/on\"><buttonclass=\"button\">ON</button></a></p>");
